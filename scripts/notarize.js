 ...
 * notarize.js
 * Usage:
 *   NODE_URL="https://sepolia.infura.io/v3/..." PRIVATE_KEY="0x..." NOTARY_CONTRACT="0x..." node scripts/notarize.js --hash 0x<sha256> --cid <ipfs_cid>
 *
 * IMPORTANT: Use env vars or a secrets vault. Do NOT hardcode PRIVATE_KEY.
 */
...
const argv = yargs(hideBin(process.argv))
  .option("hash", {
    type: "string",
    demandOption: true,
    describe: "0x-prefixed SHA256 bundle hash",
  })
  .option("cid", {
    type: "string",
    demandOption: false,
    describe: "Optional IPFS CID for the bundle",
  })
  .strict().argv;
