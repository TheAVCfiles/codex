...
export default function LedgerReport({ founderId = "avc_beta" }) {
      ...
      <section style={styles.summary}>
        <div style={styles.summaryCard}>
          ...
          <div style={styles.summaryText}>
            Each row includes a SHA-256 hash derived from the transition payload. If any field changes,
            the hash no longer matches the original entry.
          </div>
        </div>
        <div style={styles.summaryCard}>
          <div style={styles.summaryLabel}>Export Method</div>
          <div style={styles.summaryText}>
            Use browser Print → “Save as PDF”. This produces a packet with repeated table headers.
          </div>
        </div>
      </section>
