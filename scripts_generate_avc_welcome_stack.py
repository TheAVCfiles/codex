...
def build_pdf_1(output_dir: Path, styles):
    file_path = output_dir / "AVC_Welcome_Founder_Reality_Kit.pdf"
...
def build_pdf_2(output_dir: Path, styles):
    file_path = output_dir / "AVC_Founder_Reality_Kit_Templates.pdf"
    doc = SimpleDocTemplate(
        str(file_path),
        pagesize=LETTER,
        rightMargin=54,
...
def build_pdf_3(output_dir: Path, styles):
    file_path = output_dir / "AVC_Governance_Primer.pdf"
    doc = SimpleDocTemplate(
        str(file_path),
        pagesize=LETTER,
        rightMargin=54,
...
def main():
    ...
    created = [
        build_pdf_1(output_dir, styles),
        build_pdf_2(output_dir, styles),
        build_pdf_3(output_dir, styles),
    ]
